 ...
 *
 * Merged (0.6.5): the parity line grew its own leaner copy of this file for the
 * Phase H suites. This is the superset of the two — it runs those `*.test.ts`
 * files unchanged, and additionally carries the React transform and the version
 * define that the component suites need.
 */
