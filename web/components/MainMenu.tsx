...
const DialTile: React.FC<{
  ...
  shadow: string;
  onClick: () => void;
}> = ({ quadrant, label, icon, face, shadow, onClick }) => (
  <button
    onClick={onClick}
    ...
    >
      <div className="flex-1 min-h-0 w-full flex items-center justify-center bg-dex-screen relative overflow-hidden p-4">
        ...
        >
          ...
          >
            <DialTile quadrant="tl" label="GRAPES" face="#a855f7" shadow="#6b21a8" icon={<Grip className="w-11 h-11 sm:w-14 sm:h-14" />} onClick={() => onNavigate('GRAPES')} />
