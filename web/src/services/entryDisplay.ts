...
export function appellationName(classification: string, country: string): string {
  ...
  switch (system.toUpperCase()) {
    ...
    case 'AOP': return "Appellation d'Origine Protégée";
    case 'IGP': return 'Indication Géographique Protégée';
    ...
    case 'IG': return 'Indicación Geográfica';
    ...
    case 'PAGO': return 'Vino de Pago';
    case 'VP': return 'Vino de Pago';
    case 'PRÄDIKAT': return 'Prädikatswein';
    case 'QBA': return 'Qualitätswein bestimmter Anbaugebiete';
    case 'VDP': return 'Verband Deutscher Prädikatsweingüter';
    case 'PUTTONYOS': return 'Tokaji Aszú puttonyos scale';
    case 'VCP': return 'Vino de Calidad Preferente';
    case 'VQA': return 'Vintners Quality Alliance';
    case 'ZOI': return 'Zaštićena Oznaka Izvornosti';
    case 'AOG': return "Appellation d'Origine Garantie";
